    ...
    <div class="box box-primary">
        <div class="box-header">
            ...
            <div class="box-tools">
            	...
            	<a class="btn btn-sm btn-default pull-right" onclick="show_modal(this);return false" title="Tambah Pengguna Baru" href="<?php echo base_url('account/new_data');?>" style="margin-left:5px"><i class="fa fa-plus-square"></i> Tambah Pengguna</a>
                <?php } ?>
            </div>
        </div>
        <!-- /.box-header -->
                ...
                <table class="table table-bordered table-hover table-stripped" id="data_table">
                    <thead>
                        <tr>
                            ...
                            <th width="45%">
                            	<a href="javascript:;" id="sort-btn" data-page="1" data-order="user_name" data-direction="ASC">UserName</a>
                            </th>
                            <th width="15%">
                            	<a href="javascript:;" id="sort-btn" data-page="1" data-order="user_level" data-direction="ASC">Level Pengguna</a>
                            </th>
                            <th width="10%">
...
function load_table(page,order,dir){
	...
	var jenis	= $('#type').val();
	$.ajax({
		url		: base_url + 'account/data_table',
		type	: 'POST',
