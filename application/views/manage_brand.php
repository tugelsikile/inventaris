...
<section class="content">
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Tabel Data Merek</h3>
            <div class="box-tools">
            	...
            	<a class="btn btn-sm btn-default pull-right" onclick="show_modal(this);return false" title="Tambah Merek Baru" href="<?php echo base_url('brand/new_data');?>" style="margin-left:5px"><i class="fa fa-plus-square"></i> Tambah Merek</a>
                <?php } ?>
            </div>
        </div>
        <!-- /.box-header -->
                ...
                <table class="table table-bordered table-hover table-stripped" id="data_table">
                    <thead>
                        <tr>
                            ...
                            <th width="75%">
                            	<a href="javascript:;" id="sort-btn" data-page="1" data-order="brand_name" data-direction="ASC">Nama Merek</a>
                            </th>
                            <th width="15%">
                            	Jml Barang
                            </th>
