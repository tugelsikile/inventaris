        ...
        <form role="form" id="form_siswa">
            ...
            <div class="box-body">
                <div class="form-group nopadding nama">
                    <label for="nama" class="control-label">Nama Pengguna <span class="text-warning">*</span></label>
                    <input type="text" class="form-control" id="nama" name="nama" value="" placeholder="Nama Pengguna">
                </div>
                <div class="form-group col-lg-6 col-xs-6 password nopadleft">
                	<label for="password" class="control-label">Password</label>
                    <input type="password" name="password" id="password" class="form-control" placeholder="Password" />
                </div>
                <div class="form-group col-lg-6 col-xs-6 level nopadright">
...
$(document).ready(function(e) {
	...
	$('#form_siswa').submit(function(e) {
		...
		$.ajax({
			url		: base_url + 'account/new_data_submit',
			type	: 'POST',
			data	: $(this).serialize(),
			success	: function(dt){
