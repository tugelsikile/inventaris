        ...
        <form role="form" id="form_siswa">
            <div class="box-body">
                <div class="form-group nopadding nama">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" value="" placeholder="Judul Pengajuan">
                </div>
                <div class="form-group nopadding notes">
                    ...
                    <textarea name="notes" id="notes" class="form-control" placeholder="Deskripsi Pengajuan"></textarea>
                </div>
...
$(document).ready(function(e) {
	...
	$('#form_siswa').submit(function(e) {
		...
		$.ajax({
			url		: base_url + 'pengajuan/new_data_submit',
			type	: 'POST',
			data	: $(this).serialize(),
			success	: function(dt){
